...
export const Button = forwardRef(({ active, disabled, onChange, onClick, controlled, to, href, careful = false, ...props }, ref) => {
...
export const SettingsButton = forwardRef(({ active, onChange, controlled, to, href, careful = false, ...props }, ref) => {
	const [isActive, setActive] = useState(active ?? false)
	return (
		<StyledButton2
			ref={ref}
...
export const StyledButton2 = styled(Link).attrs(props => ({
	to: props.to,
	href: props.href,
	newTab: props.newTab
})).withConfig({
